...
The starter currently ships with English only; add a new locale by mirroring the patterns below.
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="content" defaultOpen>
      ...
      <FileTree.Folder name="fr" comment="Add more locales as needed" />
    </FileTree.Folder>
  </FileTree.Folder>
</FileTree>
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="i18n" defaultOpen>
      ...
      <FileTree.File name="new-locale.ts" comment="Add files per locale" />
    </FileTree.Folder>
...
Routing derives the locale from the first URL segment (e.g., `/en/introduction`). To add another locale, extend `src/i18n`, update `i18nConfig`, register it in `src/app/_dictionaries/get-dictionary.ts`, and add a matching content folder under `src/content`.
