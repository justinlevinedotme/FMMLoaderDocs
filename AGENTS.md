...
- Keep MDX frontmatter minimal and language folders aligned (e.g., `src/content/en` mirrors `src/content/zh`).
...
- Commits: use short, imperative messages (e.g., “Add hero animation”, “Fix zh nav links”); group related changes.
